...
beforeAll(async () => {
  ...
  const [driverAuthRoutesModule, DriverModule, DriverApplicationModule, VehicleModule] = await Promise.all([
  ...
  app.use('/api/driver', driverAuthRoutesModule.default);
});
...
beforeEach(() => {
  ...
  initialApplication.save.mockClear();
});
